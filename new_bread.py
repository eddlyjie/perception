...
if __name__ == "__main__":
    ...
    Demos = ["box_bowl", "candy", "box_box", "box_block", "lolipop", "box_ocean_ball", "cloth", "bread", "lolipop_axe", "bowl"]
    Demo = "bowl"
    ...
    if Demo == "bowl":
        ...
        for i in range(10):
            ...
            if i == 9:
                ...
                pub = rospy.Publisher('/object_poses', PoseArray, queue_size=1)
                ...
                while not rospy.is_shutdown():
                    ...
                    rospy.loginfo(f"Published {len(pose_array.poses)} object poses")
