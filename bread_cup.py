...
if __name__ == "__main__":
    ...
    Demos = ["box_bowl", "candy", "box_box", "box_block", "lolipop", "box_ocean_ball", "cloth", "bread", "lolipop_axe", "bowl", "all", "pack", "cup"]
    Demo = "cup"
    ...
    if Demo == "pack":
        bread_perception = Yolo6DPose(K, YOLO("perception/yolo_segmentation/pack0.pt"))
        for _ in range(50):
            realsense.get_frames()
        # return each bowl's [meters in front of base, meters to the left of base, meters above base]
        for i in range(10):
            demo_bread(bread_perception, "pack", realsense, merge_contours = False, vis = False)
    if Demo == "cup":
        bread_perception = Yolo6DPose(K, YOLO("perception/yolo_segmentation/cup.pt"))
        box_perception = Yolo6DPose(K, YOLO("perception/yolo_segmentation/packbox.pt"))
        pack_perception = Yolo6DPose(K, YOLO("perception/yolo_segmentation/pack0.pt"))
        for _ in range(50):
            realsense.get_frames()
